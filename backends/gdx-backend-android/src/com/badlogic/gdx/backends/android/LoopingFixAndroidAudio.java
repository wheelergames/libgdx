 ...
 * 
 * @author mzechner */
public final class LoopingFixAndroidAudio implements AndroidAudio {
	private final SoundPool soundPool;
	private final AudioManager manager;
	public final List<LoopingFixAndroidMusic> musics = new ArrayList<LoopingFixAndroidMusic>();
	...
	public void pause() {
		...
		synchronized (musics) {
			for (LoopingFixAndroidMusic music : musics) {
				if (music.isPlaying()) {
					music.pause();
	...
	public Music newMusic (FileDescriptor fd) {
		...
		try {
			...
			LoopingFixAndroidMusic music = new LoopingFixAndroidMusic(this, fd);
			synchronized (musics) {
				musics.add(music);
			}
			return music;
	...
	public void dispose () {
		...
		synchronized (musics) {
			...
			ArrayList<LoopingFixAndroidMusic> musicsCopy = new ArrayList<LoopingFixAndroidMusic>(musics);
			for (LoopingFixAndroidMusic music : musicsCopy) {
				music.dispose();
			}
		}
		soundPool.release();
